#ifndef MENTORSTRATEGY_H
#define MENTORSTRATEGY_H
...
class MentorStrategy : public CountingStrategy { //in docs note deck size is counted 100% accuratly in half size increments
    private:
        float true_count = 0;
