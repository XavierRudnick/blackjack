#ifndef ZENCOUNTSTRATEGY_H
#define ZENCOUNTSTRATEGY_H
...
class ZenCountStrategy : public CountingStrategy { //in docs note deck size is counted 100% accuratly in half size increments
    private:
        float true_count = 0;
        ...
        static constexpr float evPerTC = .002748f; // 0.275% per TC from 2deck 75pen data
