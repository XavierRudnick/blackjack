#ifndef KISSIIISTRATEGY_H
#define KISSIIISTRATEGY_H
...
class KISSIIIStrategy : public CountingStrategy { //in docs note deck size is counted 100% accuratly in half size increments
    private:
    ...
    public:
        KISSIIIStrategy(float deck_size);
