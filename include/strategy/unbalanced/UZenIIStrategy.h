#ifndef UZenIIStrategy_H
#define UZenIIStrategy_H
...
class UZenIIStrategy : public CountingStrategy { //in docs note deck size is counted 100% accuratly in half size increments
    private:
    ...
    public:
        UZenIIStrategy(float deck_size);
