#ifndef UstonSSSTRATEGY_H
#define UstonSSSTRATEGY_H
...
class UstonSSStrategy : public CountingStrategy { //in docs note deck size is counted 100% accuratly in half size increments
    private:
